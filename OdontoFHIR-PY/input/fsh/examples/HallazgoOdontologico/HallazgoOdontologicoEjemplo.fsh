...
* asserter = Reference(Practitioner/23)
* bodySite = https://odontofhir.py/fhir/CodeSystem/AnatomiaDental-OdontoFHIR-1#13006OF "Canino superior derecho permanente completo"
