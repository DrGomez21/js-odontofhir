Instance: HallazgoOdontologico-JuanOdontopediatria-HigieneOralDeficienteDI

InstanceOf: OdontoFHIR-HallazgosOdontologicos-Observation-1
Title: "Hallazgo Odontológico - Higiene oral deficiente (diente izquierdo)"
Description: "Se identificó higiene oral deficiente en Juan durante su primera consulta, afectando un incisivo inferior izquierdo."
