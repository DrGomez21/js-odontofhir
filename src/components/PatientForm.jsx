  ...
  return (
    <div className="p-4 w-auto max-w-[800px] bg-primary rounded-lg justify-center items-center">
        <form className="flex flex-col justify-center items-center" onSubmit={handleSubmit(onSubmit)}>
          ...
          <button
            className="flex hover:cursor-pointer gap-2 mt-4 items-center font-semibold hover:scale-105 rounded-lg bg-accent px-4 py-2 shadow-2xl transition-all text-text hover:shadow-accent"
          >
